    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Tambah Jenis Sepatu</h3>
        ...
        <div class="card-body">
        <form action="proses_tambahsepatu.php" method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Jenis Sepatu</label>
                    <input type="text" class="form-control" name="jenis_sepatu" id="jenis_sepatu" placeholder="Jenis Sepatu">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Harga</label>
                    <input type="text" class="form-control" name="harga_sepatu" id="harga_sepatu" placeholder="Harga">
                  </div>
