				...
				if(mysqli_num_rows($sql) > 0){
					...
					while($data = mysqli_fetch_assoc($sql)){
						...
						<tr>
                            ...
                            <td>'.$data['username'].'</td>
              <td>
              <a type="button" class="btn btn-success" href="edit_user.php?id='.$data['id_user'].'">Edit</a>
              <a type="button" class="btn btn-danger" href="delete_user.php?id='.$data['id_user'].'">Delete</a>
              </td>
						</tr>
						';
						$no++;
