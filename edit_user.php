...
include('config.php');
$id = @$_GET['id'] ;
$sql = mysqli_query($koneksi, "SELECT * from user where id_user ='$id'") or die(mysqli_error($koneksi));
        ...
        <form action="update_user.php" method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?php echo $data['nama'] ?>" name="nama" id="nama" placeholder="Nama">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="no_telp" id="no_telp" value="<?php echo $data['no_telp'] ?>" placeholder="No Telepon">
                  </div>
                  <div class="form-group">
